...
// Step 1: Call calculateAverage with numbers: 85, 92, 78, 96
const avg = calculateAverage(85, 92, 78, 96)
console.log("Average score: " + avg) // Step 2: Print result

// Step 3: Call createFullName with: "Dr.", "John", "Smith", "Jr."
const fullName = createFullName("Dr.", "John", "Smith", "Jr.")
console.log("Full name: " + fullName) // Step 4: Print result

// Step 5: Call findMax with numbers: 23, 45, 12, 67, 34
const max = findMax(23, 45, 12, 67, 34)
console.log("Highest number: " + max) // Step 6: Print result 