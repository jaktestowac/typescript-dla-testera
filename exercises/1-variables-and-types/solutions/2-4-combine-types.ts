...
// 👇 Your code here 👇
const username = "Aga" // Step 1: Create a variable called `username` and assign it a string value
const score = 88 // Step 2: Create a variable called `score` and assign it a number value
const isOnline = true // Step 3: Create a variable called `isOnline` and assign it a boolean value
console.log(username + " has " + score + " points. Online: " + isOnline) // Step 4: Print using string concatenation
console.log(`${username} has ${score} points. Online: ${isOnline}`) // Step 5: Print using template literals
