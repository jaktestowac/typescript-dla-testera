...
// 👇 Your code here 👇 
const isDone = true // Step 1: Create a variable called `isDone` and assign it a boolean value
let notSet // Step 2: Create a variable called `notSet` without assigning any value
console.log("Type of isDone: " + typeof isDone) // Step 3: Use typeof operator to check the type of isDone
console.log("Type of notSet: " + typeof notSet) // Step 4: Use typeof operator to check the type of notSet