...
console.log("Test Case 1 - Task created:", task1)

completeTask(task1)
console.log("Test Case 2 - Task completed:", task1)

const task2 = createTask("Build Calculator")
console.log("Test Case 3 - Task created:", task2)
