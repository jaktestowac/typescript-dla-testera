...
// 📤 Expected Output:
// -------------------------
// Reading created: { id: 1, temperature: 25, humidity: 60 }
// Reading created: { id: 2, temperature: 18, humidity: 75 }
// Temperature updated: { id: 1, temperature: 28, humidity: 60 }
// -------------------------
...
function createWeatherReading(temperature: number, humidity: number): WeatherReading {
...
const reading1 = createWeatherReading(25, 60)
console.log("Test Case 1 - Reading created:", reading1) // Should print { id: 1, temperature: 25, humidity: 60 }

const reading2 = createWeatherReading(18, 75)
console.log("Test Case 2 - Reading created:", reading2) // Should print { id: 2, temperature: 18, humidity: 75 }

updateTemperature(reading1, 28)
console.log("Test Case 3 - Temperature updated:", reading1) // Should print { id: 1, temperature: 28, humidity: 60 }
