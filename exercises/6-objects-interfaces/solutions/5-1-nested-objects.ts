...
// 👇 Your code here 👇
const user = {
    // Step 1: Create object with nested structure
    name: "John",
    address: {
        street: "123 Main St",
        city: "New York",
...
console.log("User: " + user.name) // Step 3: Print user's name
console.log("Street: " + user.address.street) // Print street
console.log("Theme: " + user.preferences.theme) // Print theme
